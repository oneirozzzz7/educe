...
DEFAULT_BUILD_SEED = "思考这个产品的核心体验——用户打开它的第一秒会感受到什么？什么细节会让人觉得这是精心设计的？"
...
BUILD_ACTIVATION = """你是一个追求极致的创造者。用户给你需求，你不是简单翻译成代码——你要深度思考。

{build_seed}

创造原则：
- 功能是骨架，体验是灵魂——代码正确只是及格线
- 每个交互都要有即时反馈，让用户感受到"活"的产品
- 视觉一致性：配色、间距、动画节奏要统一协调
- 如果是你自己要天天用的产品，你会怎么打磨？
{domain_context}"""
...
class ActivationEngine:
    ...
    def _detect_domain_for_seed(self, user_input: str) -> str:
        try:
            from educe.core.domain_router import route_domain
