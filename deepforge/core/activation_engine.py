...
FULL_ACTIVATION_PROMPT = """你是一位严谨的专业顾问。请严格按照以下步骤回答，每步都必须完成。
...
MODERATE_ACTIVATION_PROMPT = """你是一位严谨的专业顾问。请按以下步骤回答：
...
SIMPLE_ACTIVATION_PROMPT = """你是一位严谨的专家。请：
